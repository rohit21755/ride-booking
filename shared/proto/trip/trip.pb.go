...
func (x *PreviewTripRequest) GetStart() *Coordinate {
	if x != nil {
		return x.Start
	}
	return nil
...
const file_trip_proto_rawDesc = "" +
	...
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude\"\x88\x01\n" +
	"\x12PreviewTripRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\x12&\n" +
	"\x05start\x18\x02 \x01(\v2\x10.trip.CoordinateR\x05start\x122\n" +
	...
	"\n" +
	"CreateTrip\x12\x17.trip.CreateTripRequest\x1a\x18.trip.CreateTripResponseB\x15Z\x13./shared/proto/tripb\x06proto3"
...
var file_trip_proto_depIdxs = []int32{
	0,  // 0: trip.PreviewTripRequest.start:type_name -> trip.Coordinate
